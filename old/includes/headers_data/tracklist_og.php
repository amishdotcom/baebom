...
<meta property="og:description" content="<?php if(isset($album_name)){echo "Tracklist for $album_name";} ?><?php if(isset($composer_main)){echo " by $composer_main";} ?><?php echo " on $site_name"; ?>" />
<meta property="og:type" content="music.tracklist" />
...
<meta property="twitter:description" content="<?php if(isset($album_name)){echo "Tracklist for $album_name";} ?><?php if(isset($composer_main)){echo " by $composer_main";} ?><?php echo " on $site_name"; ?>" />
