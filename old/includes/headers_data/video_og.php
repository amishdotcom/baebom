...
<meta property="og:description" content="Watch <?php if(isset($track_name)){echo $track_name;} ?><?php if(isset($track_composer)){echo " by $track_composer";} ?><?php if(isset($track_artist)){echo ", $track_artist ";} ?>now on <?php echo $site_name ?>" />
...
<meta property="twitter:description" content="Watch <?php if(isset($track_name)){echo $track_name;} ?><?php if(isset($track_composer)){echo " by $track_composer";} ?><?php if(isset($track_artist)){echo ", $track_artist ";} ?>now on <?php echo $site_name ?>" />
