...
<!--headin5_amrc-->
<p class="mb10">baebom is an upbuilding Internet Music Database which has the collection of all Music Albums and their respective tracks from round the globe. The Project is started by <a style="color:white" href="https://www.facebook.com/amishdotcom/" target="_blank">Amish Dotcom</a> with a mission to provide Internet users round the globe with most Authentic Information related to music.</p>
<p><i class="fa fa-location-arrow"></i> GL Bajaj, Plot No.2, Knowledge Park III, Greater Noida, Uttar Pradesh 201306, India </p>
...
<?php if ($page_type == 'policy'){echo "<li><a href=\"#\">Data Collection Policy</a></li>\n";} else {echo "<li><a href=\"$site_root/policy\">Data Collection Policy</a></li>\n";} ?>
...
<p class="text-center">Copyright @ 2019 <a href="http://cybertronics.org.in">Cybertronics</a> | Designed & Developed by <a href="https://www.facebook.com/amishdotcom/">Amish Dotcom</a></p>
...
<li><a href="https://www.facebook.com/baebom.music/"><i class="fab fa-facebook-f"></i></a></li>
<li><a href="https://twitter.com/baebom_music"><i class="fab fa-twitter"></i></a></li>
</ul>
