...
class CPdf
{
    ...
    /**
     * @var float Used to track the last used value of the inter-html2word spacing, this is so that it is known
    ...
    /**
     * define the documentation catalog, the overall controller for the documentation
     */
...
//      }
    ...
    /**
     * add a link in the documentation to an internal destination (ie. within the documentation)
     */
    ...
    /**
     * intialize a new documentation
     * if this is called on an existing documentation results may be unpredictable, but the existing documentation would be lost at minimum
    ...
    function addText($x, $y, $size, $text, $angle = 0, $wordSpaceAdjust = 0, $charSpaceAdjust = 0, $smallCaps = false)
    {
        ...
        if ($start < $len) {
            ...
            // modify unicode text so that extra html2word spacing is manually implemented (bug #)
            $cf = $this->currentFont;
