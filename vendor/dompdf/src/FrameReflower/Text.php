...
//     Helpers::pre_r($words);
        ...
        // The first html2word has overflowed.   Force it onto the line
    ...
    protected function _layout_line()
    {
        ...
        if ($split !== false) {
            ...
            if ($split == 0) {
                ...
                // leaves enough space to fit the next html2word in the text stream (because pdf layout
    ...
    function get_min_max_width()
    {
        ...
        switch ($style->white_space) {
            ...
            case "pre-line":
                ...
                // Find the longest html2word (i.e. minimum length)
