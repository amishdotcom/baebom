 ...
 * html2word) based on their CSS display property ({@link
 ...
 * of the documentation.  Space constraints (containing block width & height) are
 * pushed down, and resolved positions and sizes bubble up.  Thus, every
 * {@link Frame} in the documentation tree is traversed once (except for tables
